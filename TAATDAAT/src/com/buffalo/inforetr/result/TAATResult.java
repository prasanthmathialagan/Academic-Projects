 ...
 *
 */
public class TAATResult implements Result
{
	private final String functionName;
	private final String[] terms;
	private int comparisons;
	private double elapsedTime;
	private int optimizedComparisons; // TODO : To implement
	private List<Long> docIDs;
	private final boolean isEmptyResult;
	
	public TAATResult(String functionName, String[] terms, boolean isEmptyResult)
	{
	...
	public String getResultString()
	{
		...
		if(!isEmptyResult)
		{
			...
			sb.append(optimizedComparisons).append(" comparisons are made with optimization (optional bonus part)").append('\n');
			sb.append("Result: ");
	...
	public void setOptimizedComparisons(int optimizedComparisons)
	{
		this.optimizedComparisons = optimizedComparisons;
	}
